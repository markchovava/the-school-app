...
class StudentPrimaryController extends Controller
{
    protected $title = 'Primary School';

    /* List All Students in High School Only */
    public function index(){
        $school = School::where('name', 'LIKE', '%' . 'Primary' . '%')->first();
        $usertype = UserType::where('level', 1)->first(); // 1 is for Student
        ...
        return view('backend.student.primary.index', $data);
    }
    ...
    public function add(){
        ...
        $data['school'] = $school;
        $data['title'] = $this->title;
        return view('backend.student.primary.add', $data);
    }
    ...
    public function store(Request $request){
        ...
        return redirect()->route('admin.student.primary');
    }
    ...
    public function edit($id){
        ...
        $data['user'] = $user;
        $data['title'] = $this->title;
        return view('backend.student.primary.edit', $data);
    }
   ...
   public function view($id){
        ...
        return view('backend.student.primary.view', $data);
   }
