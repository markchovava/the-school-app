        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <!--begin::Form-->
                    <form method="POST" action="{{ route('admin.student_class.primary.update', $student_class->id) }}" class="form">
                        @csrf
                        <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                <!--begin::Label-->
                                <div class="col-lg-4 fw-bold fs-6 text-muted">
                                    Class:
                                </div>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8 fw-bold fs-6">
                                    <b>{{ $student_class->grade->name }}</b>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                        ...
                        <div class="card-footer d-flex justify-content-end py-6 px-9">
                           <a href="{{ route('admin.student_class.primary') }}" class="btn btn-primary">All Classes</a>
                        </div>
                        <!--end::Actions-->
                    </form>
                    <!--end::Form-->
