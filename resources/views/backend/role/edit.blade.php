        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <!--begin::Form-->
                    <form method="POST" action="{{ route('admin.role.update', $role->id) }}" class="form">
                        @csrf
                        <!--begin::Card body-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row d-flex">
                                    ...
                                    <select name="level" aria-label="Select an option." data-control="select2" 
                                        ...
                                        <option value="3" {{ $role->level == 3 ? 'selected="selected"' : '' }}> Third </option>
                                        <option value="4" {{ $role->level == 4 ? 'selected="selected"' : '' }}> Forth </option>
                                    </select>
                                    <!--end::Input-->
                                </div>
                                <!--end::Col-->
